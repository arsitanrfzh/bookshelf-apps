            ...
            <article class="book_item">
                ...
                <div class="action" style="margin-top: 30px;">
                    <button class="green" onclick="readedBook('${book.id}')">
                        <img class="agree-icon" style="top:10px;" src="./image/agree-icon.png" alt="agree-icon">&nbsp;
                        <span>Selesai dibaca</span>
                    </button>
                    <button class="red" onclick="deleteBook('${book.id}')">
                        <img class="disagree-icon" style="top:10px;" src="./image/disagree-icon.png" alt="disagree-icon">&nbsp;
...
function deleteBook(id) {
    let cfm = confirm("Anda yakin ingin menghapus data buku ini ?");
